...
public class MainFrame extends JFrame {
	...
	private void setupMenus() {
		...
		JMenuItem fileMenuOpen = new JMenuItem(_resMgr
				.getString("menu.file.open"));
		JMenuItem fileMenuExit = new JMenuItem(_resMgr
				.getString("menu.file.exit"));
		// ActionListener
		...
		JRadioButtonMenuItem modeMenuUnite = new JRadioButtonMenuItem(_resMgr
				.getString("menu.mode.unite"), true);
		JRadioButtonMenuItem modeMenuDivide = new JRadioButtonMenuItem(_resMgr
				.getString("menu.mode.divide"), false);
		// ActionListener
		...
		JMenuItem optionMenuSettings = new JMenuItem(_resMgr
				.getString("menu.option.settings"));
		// ActionListener
